...
function Header() {
    ...
    return (React.createElement(React.Fragment, null,
        ...
        React.createElement("div", { className: "h-full w-full absolute " + (hambur ? "block" : "hidden transition-all") + " block sm:hidden bg-gray-300 top-0 z-0" },
            React.createElement("ul", { className: "m-12" },
